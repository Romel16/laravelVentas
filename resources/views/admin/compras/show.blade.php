...
@section('content_header')
    <h1><b>Compras / Detalle de Compras</b></h1>
    <hr>
@stop
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" value="{{$compra->detalles->first()->proveedor->empresa}}" disabled></input>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" style="text-align: center;background-color: #cccc" class="form-control" value="{{$compra->precio_total}}" name="precio_total" disabled>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <a href="{{url('/admin/compras')}}" class= "btn btn-secondary"><i class="fa-solid fa-circle-xmark"> Cancelar</i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
