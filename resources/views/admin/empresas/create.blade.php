...
<div class="container">
    ...
    <center>
        <img src="{{asset('/imagen/inicio.png')}}" width="200px" height="70%" alt="">
    </center>
    <br>
                    ...
                    <form action="{{url('crear-empresa/create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"name ="tipo_empresa" class="form-control" required> @error('tipo_empresa')
                                            <small style="color: red;">{{$message}}</small>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('nit')}}" name="nit" class="form-control" required> @error('nit')
                                            <small style="color: red;">{{$message}}</small>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{old('nombre_impuesto')}}" name="nombre_impuesto"class="form-control" required> @error('nombre_impuesto')
                                                <small style="color: red;">{{$message}}</small>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" value="{{old('cantidad_impuesto')}}" name="cantidad_impuesto"class="form-control" required> @error('Cantidad')
                                                <small style="color: red;">{{$message}}</small>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{old('telefono')}}" name="telefono"class="form-control" required> @error('telefono')
                                                <small style="color: red;">{{$message}}</small>
                                                @enderror
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="email" value="{{old('correo')}}" name="correo"class="form-control" required> @error('correo_empresa')
                                                <small style="color: red;">{{$message}}</small>
                                                @enderror
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            ...
                                            <input id="pac-input" class="form-control" name="direccion" type="text" placeholder="Buscar..." required>@error('direccion')
                                            <small style="color: red;">{{$message}}</small>
                                            @enderror
                                            <br>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <button type="submit" class="btn btn-lg btn-primary btn-black">Crear empresa</button>
                                    </div>
                                </div>
...
<script>
    $(document).on('change','#select_estado',function(){
        ...
        if (id_estados) {
            $.ajax({
                url: "{{url('/crear-empresa/estado/')}}"+'/'+id_estados,
                type:"GET",
                success:function(data){
