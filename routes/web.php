...
Route::post('/admin/arqueos/create_ingresos_egresos', [App\Http\Controllers\ArqueoController::class, 'store_ingreso_egreso'])->name('admin.arqueos.storeingresoegreso')->middleware('auth');
